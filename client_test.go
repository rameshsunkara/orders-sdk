...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Orders.List(context.Background(), ordersapi.OrderListParams{})
	if userAgent != fmt.Sprintf("Ordersapi/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Orders.List(context.Background(), ordersapi.OrderListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Orders.List(cancelCtx, ordersapi.OrderListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Orders.List(deadlineCtx, ordersapi.OrderListParams{})
		if err == nil {
